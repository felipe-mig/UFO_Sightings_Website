...
<body style="background-color: #1b1b1b">
        ...
        if($validate){
            ...
            echo '<header class="headerPages" style="position: fixed;">
          <!--logo-->
          ...
          <nav>
            <ul>
                ...
                <li><a href="create_post_section.php">Add a post</a></li>
            </ul>
          </nav>
        ...
        echo '
            ...
            <div class="postContainer">';
                viewCreatedPost($dbConnect);
           '</div>';
            
        echo '</div>';

        } else {
            // header('location: ./login_section.php');
        ...
        //   <!--logo-->
          ...
          <nav>
            <ul>
                ...
                <br><br>
                <br><br>
                <form action="login_section.php" method="post" style="margin-bottom: 22.25vh;">
                        <br>
