...
<body style="background-color: #000000;">
        ...
        <?php
            if($validate){        
                ...
                <h3>Add a Post</h3>
                <br><br>
                <form action="action_create_post.php" method="post" class="form2" style="">
                        <br>
                        <input type="text" name="location" value="" placeholder="Location" class="input2" style=" all:unset; color: #FFFFFF; background-color: rgba(0, 0, 0, 0.7); margin-top: 3.5vh;  border: 1px solid #D2FF06; border-radius: 10px; width: 20vw; font-family: orbitron; height: 5vh; padding-left: 0.5vw; display: block; margin: 1.5vh auto; text-transform: capitalize;" >
                        <input type="date" name="date" value="" class="input2">
                        <input type="time" name="time" value="" class="input2" >
                        <br>
                        <textarea name="description" placeholder="Description"></textarea>
                        <span id="login-span"></span>
                        <br><br><br>
                         <i style="position: absolute; margin-top: 3.15vh; margin-left: 10vw; font-size: 1.1em; color: rgba(210, 255, 6, 0.9);" class="fa fa-plus-square"></i>
                        <input type="submit" value="post" id="login-submit-button">
                        <br>
                </form>
                ';
            } else {
